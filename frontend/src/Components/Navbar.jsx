...
function Navbar(){
    ...
    return(
        ...
        <div className={`max-w-screen-2xl container  mx-auto md:px-20 px-4 dark:bg-slate-900 dark:text-white fixed top-0 left-0 right-0 z-50 ${
            sticky? "sticky-navbar shadow-md bg-base-200 dark:bg-slate-800 dark:text-white duration-3000 transition-all ease-in-out" : ""
        }`}>
  ...
  <div className="navbar-start">
    ...
    <a className="text-2xl font-bold cursor-pointer ml-10px">Book Store</a>
  </div>
